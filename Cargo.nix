    ...
    crates = {
      ...
      "gen-macros" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "32ed7d29631ac351566e5745a96ef60328e1cf30";
          sha256 = "0drk51af71zyd9a4g2glnj02vl9cjl6894ncgcb7mbf5dxi5r6nm";
        };
        procMacro = true;
        libName = "gen_macros";
        authors = [
      ...
      "shikumi" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "0d50d62e78a0e1d69ac4e92fb2d5c9032babeab6";
          sha256 = "08bcym3bcvflg6ba8q6p6fd1n8w9hixrbr7kv9ddh86walh543ap";
        };
        dependencies = [
          {
            name = "arc-swap";
